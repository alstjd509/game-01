...
HK.CFG = {
  ...
  UPGRADES: {
    tank: { name: '산소통', costs: [10, 25, 60, 110, 220] }, // Lv4·5 완화 140·300→110·220 (밸런스 패스: 심부 왕복 현실화)
    ...
    elev: { name: '승강기', costs: [40, 120] }, // 층 시작점 해금 (밸런스 패스: 하강세 제거 — 없으면 심부 유물 도달률 2%)
  },
...
HK.upgradeDesc = {
  ...
  elev: function (lv) { return '출발 깊이: ' + HK.CFG.ELEV_DEPTHS.slice(0, lv + 1).join('m·') + 'm'; },
};
